        ...
        <div class="w-full px-[2rem] lg:px-[12rem] xl:px-[10vw] flex flex-col bg-screenBlack font-body text-body text-screenBlack">
            ...
            <div class="flex flex-col lg:grid lg:grid-cols-[3fr_2fr_8fr] h-max lg:h-[5rem] gap-4">
                ...
                <div class="flex items-center relative justify-end h-[5rem]">
                    <!-- Search bar -->
                    <label for="search-input" class="sr-only">Search integrators</label>
                    <input 
                        id="search-input"
                        v-model="searchInput"
                        type="text" 
                    ...
                    >
                        ...
                        <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full" aria-hidden="true" role="img">
                            <circle cx="17.2961" cy="17.2961" r="15.7961" stroke="#000000" stroke-width="3"/>
                            <path d="M27.5068 30.4541L30.4539 27.5071L43.5978 40.651C43.9883 41.0415 43.9883 41.6747 43.5978 42.0652L42.065 43.598C41.6745 43.9886 41.0413 43.9886 40.6508 43.598L27.5068 30.4541Z" fill="#000000"/>
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <div class="z-20 top-0 grid grid-cols-[4rem_2fr_1fr_2fr_2fr] md:grid-cols-[8rem_2fr_1fr_2fr_1fr] text-text-xs md:text-text-sm xl:text-body overflow-y-auto text-pearl-white py-[2rem] gutterStable">
                ...
                >
                    ...
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="hidden md:flex" aria-hidden="true" role="img">
            ...
            <div class="w-full flex justify-center items-center py-[2rem]">
                <div class="flex gap-[2rem] items-center justify-center h-[4rem]">
                    ...
                    >
                        ...
                        <svg width="15" height="30" viewBox="0 0 15 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full" aria-hidden="true" role="img">
