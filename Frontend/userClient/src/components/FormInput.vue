...
<template>
	<div class="relative h-[8rem] flex justify-start items-end text-body text-screenBlack">
		<div :class="{
			...
			<button v-if="type == 'password'" @click="toggleInputType" class="absolute h-full aspect-square right-[2rem] top-0 flex justify-center items-center fill-screenBlack lg:hover:fill-primary group p-2">
