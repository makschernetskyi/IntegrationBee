			...
			<div class="relative h-full flex items-center justify-between font-heading text-subtitle">
                <div>
                    <a href="#" draggable="false" class="flex items-center gap-3 lg:hover:bg-screenBlack-400 lg:hover:bg-opacity-15 lg:transition-all lg:duration-100 rounded-[10px] px-2 py-2" @click.prevent="handleNavigation('/')">
                        <span class="h-[4rem] w-[4rem]">
                            <svg width="41" height="41" viewBox="0 0 41 41" class="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.04098 21V38.5H32.6311V21M2 17.5L20 2L38.5 17.5" stroke="#242424" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </span>
                    </a>
                </div>
                <div class="flex items-center gap-4">
                    <a href="#" draggable="false" class="flex items-center gap-3 lg:hover:bg-screenBlack-400 lg:hover:bg-opacity-15 lg:transition-all lg:duration-100 rounded-[10px] px-4 py-2" @click.prevent="handleNavigation('/rankings')">
                        <span class="h-[4rem] w-[4rem] p-1">
                            <svg width="37" height="36" viewBox="0 0 37 36" class="w-full h-full fill-inherit" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="22" height="10" rx="2" fill="#242424"/>
                                <rect y="13" width="32" height="10" rx="2" fill="#242424"/>
                                <rect y="26" width="37" height="10" rx="2" fill="#242424"/>
                            </svg>
                        </span>
                        Leaderboards
                    </a>
                    ...
                    <a href="#" draggable="false" class="flex items-center gap-3 lg:hover:bg-screenBlack-400 lg:hover:bg-opacity-15 lg:transition-all lg:duration-100 rounded-[5px] rounded-[10px] px-4 py-2 fill-screenBlack" @click.prevent="handleNavigation('/myprofile')">
                        <span class="h-[4rem] w-[4rem]">
                            <svg width="45" height="43" viewBox="0 0 45 43" class="w-full h-full fill-inherit" xmlns="http://www.w3.org/2000/svg">
