...
<template>
  <div class="SignUp">
      <form class="SignUp-Form" @submit="handleSubmit">
          ...
          <AuthInput class="SignUp-Form-Field" v-model="signUpPageStore.lastName" title="Last name (Real)" placeholder="Last Name: e.g. Radon" type="text" name="last name" :is-error="errors.invalidLastName" error-msg="Invalid last name"></AuthInput>
