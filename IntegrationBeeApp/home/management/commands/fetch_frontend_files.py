		...
		for root, _, files in os.walk(build_path):
			for file in files:
				if file.endswith(".js"):
					...
					destination_path = os.path.join(base_dir,"./home/static/js/", file)
					shutil.copy2(source_path, destination_path)
				elif file.endswith(".css"):
					source_path = os.path.join(root, file)
					destination_path = os.path.join(base_dir,"./home/static/css/", file)
					shutil.copy2(source_path, destination_path)
				elif file.endswith('.html'):
					source_path = os.path.join(root, file)
					destination_path = os.path.join(base_dir,"./home/templates/home", 'home.html')
					...
					source_path = os.path.join(root, file)
					destination_path = os.path.normpath(os.path.join(base_dir,"./home/static/assets/", file))
					shutil.copy2(source_path, destination_path)
